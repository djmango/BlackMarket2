...
data:extend(
	{
		----------------------------------------------------------------------------------
		{
			...
			icon = "__MegaBlackMarket__/graphics/black-market-group.png",
			icon_size = 64,
			inventory_order = "n",
			order = "n"
		},
		...
		--------------------------------------------------------------------------------------
		{
			type = "item",
			name = "ucoin",
			icon = "__MegaBlackMarket__/graphics/ucoin.png",
			icon_size = 32,
		...
		--------------------------------------------------------------------------------------
		{
			...
			icon = "__MegaBlackMarket__/graphics/black-market-item.png",
			icon_size = 128,
			enabled = true,
			unit = {
				count = 75,
		...
		--------------------------------------------------------------------------------------
		{
			...
			icon = "__MegaBlackMarket__/graphics/black-market-fluid.png",
			icon_size = 128,
			enabled = true,
		...
		--------------------------------------------------------------------------------------
		{
			...
			icon = "__MegaBlackMarket__/graphics/black-market-energy.png",
			icon_size = 128,
			enabled = true,
		...
		--------------------------------------------------------------------------------------
		{
			...
			icon = "__MegaBlackMarket__/graphics/black-market-mk.png",
			icon_size = 128,
			enabled = true,
			upgrade = true,
...
local function add_chests(level)
	...
	chest_sell.picture = 
		{
			filename = "__MegaBlackMarket__/graphics/trading-chest-sell.png",
			priority = "extra-high",
			width = 48,
			height = 34,
			shift = {0.1875, 0}
	...
	data:extend(
		{
...

			{
				type = "item",
				name = name_sell,
				icon = "__MegaBlackMarket__/graphics/trading-chest-sell-icon.png",
				icon_size = 32,
	...
	chest_buy.picture = 
		{
			filename = "__MegaBlackMarket__/graphics/trading-chest-buy.png",
			priority = "extra-high",
			width = 48,
			height = 34,
			shift = {0.1875, 0}
	...
	data:extend(
		{
...

			{
				type = "item",
				name = name_buy,
				icon = "__MegaBlackMarket__/graphics/trading-chest-buy-icon.png",
				icon_size = 32,
				subgroup = "black-market-chests",
				order = level .. "b",
	...
	data:extend(
		{
...

			{
				type = "item",
				name = name_sell,
				icon = "__MegaBlackMarket__/graphics/trading-tank-sell-icon.png",
				icon_size = 32,
	...
	data:extend(
		{
...

			{
				type = "item",
				name = name_buy,
				icon = "__MegaBlackMarket__/graphics/trading-tank-buy-icon.png",
				icon_size = 32,
				subgroup = "black-market-tanks",
				order = level .. "b",
				place_result = name_buy,
...
local function add_accus(level)
	...
	accu_sell.chargable_graphics.picture.filename = "__MegaBlackMarket__/graphics/trading-accumulator-sell.png"
	accu_sell.chargable_graphics.charge_animation.filename = "__MegaBlackMarket__/graphics/trading-accumulator-sell-charge.png"
	accu_sell.chargable_graphics.discharge_animation.filename = "__MegaBlackMarket__/graphics/trading-accumulator-sell-discharge.png"
	...
	data:extend(
		{
...

			{
				type = "item",
				name = name_sell,
				icon = "__MegaBlackMarket__/graphics/trading-accumulator-sell-icon.png",
				icon_size = 32,
	...
	accu_buy.chargable_graphics.picture.filename = "__MegaBlackMarket__/graphics/trading-accumulator-buy.png"
	accu_buy.chargable_graphics.charge_animation.filename = "__MegaBlackMarket__/graphics/trading-accumulator-buy-charge.png"
	accu_buy.chargable_graphics.discharge_animation.filename = "__MegaBlackMarket__/graphics/trading-accumulator-buy-discharge.png"
	...
	data:extend(
		{
...

			{
				type = "item",
				name = name_buy,
				icon = "__MegaBlackMarket__/graphics/trading-accumulator-buy-icon.png",
				icon_size = 32,
				subgroup = "black-market-accumulators",
				order = level .. "b",
				place_result = name_buy,
